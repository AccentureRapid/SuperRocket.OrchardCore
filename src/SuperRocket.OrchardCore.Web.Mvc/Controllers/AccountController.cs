...
using SuperRocket.OrchardCore.Web.Models.Account;
...
using SuperRocket.OrchardCore.Web.Identity;
using SuperRocket.OrchardCore.Web.Startup;
using SuperRocket.OrchardCore.Web.Views.Shared.Components.TenantChange;
using Microsoft.AspNet.Identity;

namespace SuperRocket.OrchardCore.Web.Controllers
{
    public class AccountController : OrchardCoreControllerBase
    {
